...
- The current sandbox resource after start completes.

### `createSnapshot`

```ts
async createSnapshot(sandbox: SandboxRef, params: CreateSnapshotParams = {}, options: RequestOptions = {}): Promise<SnapshotData>
```
