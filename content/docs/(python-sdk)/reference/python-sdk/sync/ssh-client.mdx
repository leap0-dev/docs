...
Source: [`leap0/_sync/ssh.py`](https://github.com/leap0-dev/leap0-python/blob/main/leap0/_sync/ssh.py)
...
```python
delete_access(sandbox: SandboxRef, *, id: str, http_timeout: float | None = None) -> None
```
...
```python
validate_access(sandbox: SandboxRef, *, id: str, password: str, http_timeout: float | None = None) -> SshValidation
```
...
```python
regenerate_access(sandbox: SandboxRef, *, id: str, http_timeout: float | None = None) -> SshAccess
```
