...
Computer Use requires a sandbox created with the `system/desktop:v0.1.0` template. Sandboxes created with other templates do not include the desktop environment or VNC support unless you install the required packages. See <a href="/sandboxes">Sandboxes</a> for how to create one.
:::

For a full endpoint reference, see the <a href="/desktop/api">Computer Use (Desktop) API</a>.

## Desktop access

To open the desktop in a browser, see <a href="/vnc">VNC Access</a>.
