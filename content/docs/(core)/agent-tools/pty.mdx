...
export const ptyJsCreate = `import { Leap0Client } from "leap0"
...
export const ptyJsLazyCreate = `import { Leap0Client } from "leap0"
...
export const ptyJsWebSocket = `import { Leap0Client } from "leap0"
...
export const ptyJsResize = `import { Leap0Client } from "leap0"
...
export const ptyJsList = `import { Leap0Client } from "leap0"
...
export const ptyJsDelete = `import { Leap0Client } from "leap0"
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={ptyJsCreate} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={ptyJsLazyCreate} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={ptyJsWebSocket} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={ptyJsResize} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={ptyJsList} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={ptyJsDelete} />
  </TabItem>
</Tabs>
