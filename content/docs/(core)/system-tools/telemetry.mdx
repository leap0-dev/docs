...
export const telemetryJsSdkOtelExample = [
...
export const telemetryJsSandboxExport = [
  'import { Leap0Client } from "leap0"',
  "",
  'process.env.OTEL_EXPORTER_OTLP_ENDPOINT = "https://otel.example.com"',
  'process.env.OTEL_EXPORTER_OTLP_HEADERS = "x-api-key=abc123"',
...
<CodeSnippet lang="js" code={telemetryJsSdkOtelExample} />
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={telemetryJsSandboxExport} />
  </TabItem>
</Tabs>
