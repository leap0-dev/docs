...
export const firewallJsAllowAll = [
...
export const firewallJsDenyAll = [
'import { Leap0Client, NetworkPolicyMode } from "leap0"',
'',
'const client = new Leap0Client()',
'const sandbox = await client.sandboxes.create({',
...
export const firewallJsCustomDomains = [
'import { Leap0Client, NetworkPolicyMode } from "leap0"',
'',
'const client = new Leap0Client()',
'const sandbox = await client.sandboxes.create({',
...
export const firewallJsCustomTransforms = [
'import { Leap0Client, NetworkPolicyMode } from "leap0"',
'',
'const client = new Leap0Client()',
'const sandbox = await client.sandboxes.create({',
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={firewallJsAllowAll} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={firewallJsDenyAll} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={firewallJsCustomDomains} />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="JavaScript & TypeScript">
    <CodeSnippet lang="js" code={firewallJsCustomTransforms} />
  </TabItem>
</Tabs>
